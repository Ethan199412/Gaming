...
const strategies = [Strategy.Eagle, Strategy.Eagle, Strategy.NeverForgive, Strategy.Pigeon, Strategy.CunningProber, Strategy.TitForTat, Strategy.TitForTat];
...
const App = () => {
    ...
    return <div className="gaming-container">
